...
define('xtext/services/FileLoaderService', ['xtext/services/XtextService', 'jquery'], function (XtextService, jQuery) {

    /**
     * Service class for validation.
     */
    function FileLoaderService(serviceUrl, resourceId) {
        this.initialize(serviceUrl, 'fileloader', resourceId);
    };

    FileLoaderService.prototype = new XtextService();

    FileLoaderService.prototype._checkPreconditions = function (editorContext, params) {
        return this._state === undefined;
    }

    FileLoaderService.prototype._onConflict = function (editorContext, cause) {
