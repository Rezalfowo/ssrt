...
public class SsrtScopeProvider extends AbstractSsrtScopeProvider {
    ...
    public IScope getScope(EObject context, EReference reference) {
    	...
    	// We make sure that elements refines elements of one level before
        	...
        	List<Element> listRefines = ((Solution) solelement.eContainer()).getRefines().stream().map(solref -> solref.getSolutionelements()).flatMap(List::stream).toList();
            return Scopes.scopeFor(listRefines);
        } 
