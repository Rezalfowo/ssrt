...
//		System.out.println(uniqueImportURIs.getFirst().toString());
		IResourceDescriptions descriptions = getResourceDescriptions(resource, uniqueImportURIs);
//		System.out.println(descriptions.getExportedObjects());
		...
		return cache.get(ImportUriGlobalScopeProvider.class.getName(), resource, new Provider<LinkedHashSet<URI>>() {
			...
			public LinkedHashSet<URI> get() {
				...
				while (iterator.hasNext()) {
					...
					collector.accept(resourcepath + importResolver.apply(object));
				}
	 ...
	 * {@link Set set of URIs}.
	 * 
	 * The default implementation creates a new {@link URICollector}. I creates the
	 * imported URIs and normalizes potentially given class-path URIs to platform or
	 * file URIs.
	 * 
	 * @since 2.5
	 */
